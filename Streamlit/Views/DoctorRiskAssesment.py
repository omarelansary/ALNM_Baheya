...
def app():
        ...
        with st.form("Risk Assessment"):
            ...
            # Numerical inputs
                ...
                patient_first_bmi = st.number_input("First BMI", value=0.0, min_value=0.0,max_value=100.0, format="%.2f")
                patient_age = st.number_input("Age", value=0, min_value=0, max_value=150, format="%d")
                patient_size_cm = st.number_input("size cm", value=0.0, min_value=0.0,max_value=20.0,format="%.2f")
